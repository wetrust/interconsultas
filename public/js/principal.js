                ...
                $("#enviar\\.respuesta\\.botton").on("click", function(){
                    ...
                    if ($(this).val() == 3){
                        ...
                        var args = {
                            ...
                            respuesta_placenta_incersion: $('select[name="respuesta_placenta_incersion"]').val(),
