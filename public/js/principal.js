    ...
    $.get('dashboard/news').done(function(data){
        ...
        $('#tabla\\.resultado tr > td > button').on("click", function(){
            ...
            $.get('dashboard/agendar/' + solicitud_id).done(function(data){
                ...
                $("#eg_conocida").val(data.eg_conocida);
                $("#ecografia_previa").val(data.ecografia_previa);
                ...
                $("#interconsulta_profesional").val(data.interconsulta_profesional);
                ...
                $("#comentario").val(data.solicitud_i);
            });
