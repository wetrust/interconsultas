            ...
            $('#tabla\\.resultado tr > td > button').on("click", function(){
                ...
                $('#interconsulta\\.respuesta\\.crecimiento').on("change", function(){
                    if ($(this).val() == 5){
                        ...
                        $("#doppleruterinas").remove();
                        $("#final").remove();
                        $("#ver\\.interconsulta\\.contenedor").append('<div id="multiproposito"> <div class="row"> <div class="col form-group"> <label>Feto en presentación</label> <select class="form-control" name="respuesta_presentacion"> <option value="cefálica">Cefálica</option> <option value="podálica">Podálica</option> <option value="transversa">Transversa</option> <option value="indiferente">Indiferente</option> </select> </div><div class="col form-group"> <label>Dorso fetal</label> <select class="form-control" name="respuesta_dorso"> <option value="anterior">Anterior</option> <option value="lat. izquierdo">Lateralizado izquierdo</option> <option value="posterior">Posterior</option> <option value="lat. derecho">Lateralizado derecho</option> </select> </div><div class="col form-group"> <label for="interconsulta.respuesta.liquido">Líquido amniótico</label> <select class="form-control" name="respuesta_liquido"> <option value="Normal">Normal</option> <option value="Pha leve">PHA leve</option> <option value="Pha severo">PHA severo</option> <option value="Oha leve">OHA leve</option> <option value="Oha severo">OHA severo</option> </select> </div></div><div class="row"> <div class="col-4 form-group"> <label for="interconsulta.respuesta.ecografista">Placenta ubicación</label> <select class="form-control" name="respuesta_placenta"> <option value="normal" selected>normal</option> <option value="prev. lateral">prev. lateral</option> <option value="prev. marginal">prev. marginal</option> <option value="prev. parcial">prev. parcial</option> <option value="prev. total">prev. total</option> </select> </div><div class="col-4 form-group"> <label for="interconsulta.respuesta.ecografista">Placenta inserción</label> <select class="form-control" name="respuesta_placenta_insercion"> <option value="anterior" selected>anterior</option> <option value="posterior">posterior</option> <option value="fúndica">fúndica</option> <option value="lat. derecha">lat. derecha</option> <option value="lat. izquierda">lat. izquierda </option> <option value="segmentaria">segmentaria</option> </select> </div></div><div class="row"> <div class="col form-group"> <label>Evaluación de anatomía fetal</label> </div><div class="col form-group"> <select class="form-control" name="respuesta_anatomia"> <option value="de aspecto general normal">de aspecto general normal</option> <option value="hallazgos de siguientes patologías:">hallazgos ecográficos compatible con:</option> </select> </div></div><div class="row"> <div class="col-12 form-group"> <label><strong>A.- Biometría ecográfica:</strong></label> </div></div><div class="row"> <div class="col form-group"> <label>DBP (mm)</label> <input type="text" class="form-control" name="respuesta_dbp"> </div><div class="col form-group"> <label>CC (mm)</label> <input type="text" class="form-control" name="respuesta_cc"> </div><div class="col form-group"> <label>CA (mm)</label> <input type="text" class="form-control" name="respuesta_ca"> </div><div class="col form-group"> <label>LF (mm)</label> <input type="text" class="form-control" name="respuesta_lf"> </div></div><div class="row"> <div class="col form-group"> <label>Peso fetal estimado</label> <input type="number" class="form-control" name="respuesta_pfe"> </div><div class="col form-group"> <label>Percentil</label> <div class="input-group mb-2"> <div class="input-group-prepend"> <div class="input-group-text">Pct</div></div><input type="text" class="form-control" name="respuesta_pfe_pct" disabled> </div></div><div class="col form-group"> <label>CC/CA</label> <input type="text" class="form-control" name="respuesta_ccca" disabled></div><div class="col form-group"> <label>Percentil</label> <div class="input-group mb-2"> <div class="input-group-prepend"> <div class="input-group-text">Pct</div></div><input type="text" class="form-control" name="respuesta_ccca_pct" disabled> </div></div></div><div class="row"> <div class="col-12"><strong>B.- Flujometría Doppler</strong></div><div class="col form-group"> <label for="interconsulta.respuesta.uterinas">IP. Promedio uterinas</label> <input type="text" class="form-control" name="respuesta_uterinas" id="interconsulta.respuesta.uterinas"> </div><div class="col form-group"> <label for="interconsulta.respuesta.uterinas.percentil">&nbsp;</label> <div class="input-group mb-2"> <div class="input-group-prepend"> <div class="input-group-text">Pct</div></div><input type="text" class="form-control" id="interconsulta.respuesta.uterinas.percentil" disabled=""> </div><input type="hidden" class="form-control" name="respuesta_uterinas_percentil"> </div><div class="col form-group"> <label for="interconsulta.respuesta.umbilical">IP. Arteria umbilical</label> <input type="text" class="form-control" name="respuesta_umbilical" id="interconsulta.respuesta.umbilical"> </div><div class="col form-group"> <label for="interconsulta.respuesta.umbilical.percentil">&nbsp;</label> <div class="input-group mb-2"> <div class="input-group-prepend"> <div class="input-group-text">Pct</div></div><input type="text" class="form-control" id="interconsulta.respuesta.umbilical.percentil" disabled=""> </div><input type="hidden" class="form-control" name="respuesta_umbilical_percentil"> </div></div><div class="row"> <div class="col form-group"> <label for="interconsulta.respuesta.cm">IP. Cerebral media</label> <input type="text" class="form-control" name="respuesta_cm" id="interconsulta.respuesta.cm"> </div><div class="col form-group"> <label for="interconsulta.respuesta.cm.percentil">&nbsp;</label> <div class="input-group mb-2"> <div class="input-group-prepend"> <div class="input-group-text">Pct</div></div><input type="text" class="form-control" id="interconsulta.respuesta.cm.percentil" disabled=""> </div><input type="hidden" class="form-control" name="respuesta_cm_percentil"> </div><div class="col form-group"> <label for="interconsulta.respuesta.cmau">Cuociente CM / AU</label> <input type="text" disabled class="form-control" id="interconsulta.respuesta.cmau"> <input type="hidden" class="form-control" name="respuesta_cmau"> </div><div class="col form-group"> <label for="interconsulta.respuesta.cm.percentil">&nbsp;</label> <div class="input-group mb-2"> <div class="input-group-prepend"> <div class="input-group-text">Pct</div></div><input type="text" class="form-control" id="interconsulta.respuesta.cmau.percentil" disabled> </div><input type="hidden" class="form-control" name="respuesta_cmau_percentil"> </div></div><div class="row"> <div class="col-12"> <p><strong>C.- Hipótesis diagnóstica</strong></p></div><div class="col form-group"><label><strong>Crecimiento fetal (Peso)</strong></label> <select class="form-control" name="respuesta_hipotesis"> <option value="Disminuido < p3">Disminuido < p3</option> <option value="Disminuido < p10">Disminuido < p10</option> <option value="Normal p10 - p 25">Normal p10 - p 25</option><option value="Normal p26 - p 75">Normal p26 - p 75</option><option value="Normal p51 - p 75">Normal p51 - p 75</option> <option value="Normal p76 - p90">Normal p76 - p90</option> <option value="Grande >p90">Grande >p90</option> <option value="Grande >p97">Grande >p97</option> </select> </div><div class="col form-group"><label><strong>Doppler materno</strong></label> <select class="form-control" name="respuesta_doppler_materno"> <option value="no evaluado">No evaluado</option> <option value="Normal (< p95)">Normal (&lt; p95)</option> <option value="Alterado (> p95)">Alterado (&gt; p95)</option></select> </div><div class="col-6 form-group"><label><strong>Doppler fetal</strong></label> <select class="form-control" name="respuesta_doppler_fetal"> <option value="Normal (UMB, ACM y CCP)">Normal (UMB, ACM y CCP)</option> <option value="Alterado, CCP < pct 5">Alterado, CCP &lt; pct 5</option><option value="Alterado CCP < pct 5 y UMB > pct 95">Alterado CCP &lt; pct 5 y UMB &gt; pct 95</option><option value="Alterado ccp < pct 5 acm < pct 5">Alterado CCP &lt; pct 5 ACM &lt; pct 5</option><option value="Alt. CCP < pct 5 y ACM < pct 5 + UMB > p95">Alt. CCP &lt; pct 5 y ACM &lt; pct 5 + UMB &gt; p95</option></select> </div></div></div>');
                        $("#ver\\.interconsulta\\.contenedor").append('<div id="final"><div class="row"> <div class="col form-group"> <label for="interconsulta.respuesta.comentariosexamen"><strong>Comentarios de exámen</strong></label> <textarea type="text" rows="2" class="form-control" name="respuesta_comentariosexamen" id="editable"></textarea> </div></div><div class="row"> <div class="col form-group"> <label for="interconsulta.respuesta.ecografista">Ecografista</label> <input type="text" class="form-control" name="respuesta_ecografista"> </div></div></div>');
                        $("#ginecologica").remove();
                        $("#segundotrimestre").remove();
                        $("#primertrimestre").remove();
                ...
                $("#enviar\\.respuesta\\.botton").on("click", function(){
                    ...
                    if (tipoExm == 3){
                        ...
                        args = {
                            ...
                            respuesta_anatomia_segundo: $('select[name="respuesta_anatomia_segundo"]').val(),
                            respuesta_pfe_pct: $('input[name="respuesta_pfe_pct"]').val(),
                            respuesta_ccca_pct: $('input[name="respuesta_ccca_pct"]').val(),
                            respuesta_hipotesis_segundo: $('select[name="respuesta_hipotesis_segundo"]').val(),
                            respuesta_comentariosexamen: $('#editable').val(),
                            respuesta_ecografista: $('input[name="respuesta_ecografista"]').val(),
                        }
                    }
