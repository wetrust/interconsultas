...
function createCarcasaDirectorio(){
    ...
    $('body').append('<div class="modal" tabindex="-1" role="dialog" id="'+modal_id+'"> <div class="modal-dialog modal-lg" role="document"> <div class="modal-content"> <div class="modal-header"> <h5 class="modal-title">Nuevo destinatario</h5></div><div class="modal-body"> <div class="row" id="'+div_id+'"> <div class="col-4 form-group"> <label>Nombre del destinatario</label> <input type="text" class="form-control" id="modal.directorio.nombre"> </div><div class="col-4 form-group"> <label>Email destinatario</label> <input type="email" class="form-control" id="modal.directorio.email"> </div><div class="col-4 form-group"> <label>Tipo de destinatario</label> <select class="form-control" id="modal.directorio.profesion"> <option value="Referente">Referente</option> <option value="Medico">Médico</option> <option value="Matrona">Matrona</option> <option value="Paciente">Paciente</option> <option value="Administrativo">Administrativo</option> <option value="Paciente">Paciente</option> <option value="Otros">Otros</option> </select> </div></div>'+ footerModal);
