    ...
    $.get("dashboard/directorio").done(function(data){
        ...
        if (Object.keys(data).length > 0) {
            $.each(data, function(i, value) {
                ...
                var opcion = '<option value="'+value.email_profesion+'">' + value.email_nombre + '</option>';
...
function createCarcasaDirectorio(){
    ...
    $('body').append('<div class="modal" tabindex="-1" role="dialog" id="'+modal_id+'"> <div class="modal-dialog modal-lg" role="document"> <div class="modal-content"> <div class="modal-header"> <h5 class="modal-title">Nuevo Email</h5></div><div class="modal-body"> <div class="row" id="'+div_id+'"> <div class="col-4"> <div class="form-group"> <label>Profesión</label> <select class="form-control" id="modal.directorio.profesion"> <option value="medico">Médico</option> <option value="matrona">Matrona</option><option value="paciente">Paciente</option><option value="otros">Otros</option> </select> </div></div><div class="col-4"> <div class="form-group"> <label>Nombre del destinatario</label> <input type="text" class="form-control" id="modal.directorio.nombre"> </div></div><div class="col-4"> <div class="form-group"> <label>eMail</label> <input type="email" class="form-control" id="modal.directorio.email"> </div></div></div>'+ footerModal);
