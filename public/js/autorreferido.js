    ...
    $.get("dashboard/directorio").done(function(data){
        ...
        if (Object.keys(data).length > 0) {
            $.each(data, function(i, value) {
                ...
                var opcion = '<option value="'+value.email_value+'">' + value.email_nombre + '</option>';
