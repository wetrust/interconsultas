    ...
    $.get('dashboard/process').done(function(data){
        ...
        if (Object.keys(data).length > 0) {
            ...
            $('#tabla\\.resultado tr > td > button.examen').on("click", function(){
                ...
                $("#ver\\.interconsulta\\.contenedor").append('<h4 class="py-3 text-center bg-secondary mb-0 text-white">Responder a esta solicitud de interconsulta</h4>');
                ...
                $("#ver\\.interconsulta\\.contenedor").append('<div id="final" class="mt-3"> <div class="row"> <div class="col form-group"> <label for="interconsulta.respuesta.comentariosexamen"><strong>D.- Comentarios y observaciones</strong> (Interpretación clínica del profesional ecografista)</label> <textarea type="text" rows="2" class="form-control" name="respuesta_comentariosexamen" id="editable"></textarea> </div><div class="col-6 form-group"> <label for="interconsulta.respuesta.ecografista"><strong>Ecografista</strong></label> <input type="text" class="form-control" name="respuesta_ecografista"> </div></div><div class="d-flex align-items-center justify-content-around g-verde "> <div class="form-group w-25"> <label class="text-white">Opcion cambiar nombre de referente para exámen ecográfico</label> <input type="text" class="form-control" id="solicitud_nombreprofesional"> </div><div class="form-group w-25"> <label class="text-white">Opcion cambiar email de referente para exámen ecográfico</label> <input type="text" class="form-control" id="solicitud_email"> </div><button class="btn btn-light" id="solicitud.interconsulta.profesional.guardar">Guardar</button> </div></div>');
                
                $('#solicitud\\.interconsulta\\.profesional\\.guardar').on("click", function(){
                    var args = {
                        solicitud_id: $("#solicitud_id").val(),
                        solicitud_nombre: $("#solicitud_nombreprofesional").val(),
                        solicitud_email: $("#solicitud_email").val()
                    }
...
function createCarcasaDirectorio(){
    ...
    $('body').append('<div class="modal" tabindex="-1" role="dialog" id="'+modal_id+'"> <div class="modal-dialog modal-lg" role="document"> <div class="modal-content"> <div class="modal-header"> <h5 class="modal-title">Nuevo Email</h5></div><div class="modal-body"> <div class="row" id="'+div_id+'"> <div class="col-4 form-group"> <label>Actividad / Profesión</label> <select class="form-control" id="modal.directorio.profesion"> <option value="medico">Médico</option> <option value="matrona">Matrona</option> <option value="paciente">Paciente</option> <option value="otros">Otros</option> </select> </div><div class="col-4 form-group"> <label>Nombre del destinatario</label> <input type="text" class="form-control" id="modal.directorio.nombre"> </div><div class="col-4 form-group"> <label>Email</label> <input type="email" class="form-control" id="modal.directorio.email"> </div></div>'+ footerModal);
