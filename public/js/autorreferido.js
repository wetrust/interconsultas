    ...
    $.get('dashboard/process').done(function(data){
        ...
        if (Object.keys(data).length > 0) {
            ...
            $('#tabla\\.resultado tr > td > button.examen').on("click", function(){
                ...
                $("#ver\\.interconsulta\\.contenedor").append('<div class="row bg-secondary mb-0"> <div class="col form-group"> <label class="text-white"><strong>Seleccione tipo exámen</strong></label> <select class="form-control" name="solicitud_crecimiento" id="interconsulta.respuesta.crecimiento"> <option value="4">1.- Ecografía 11 / 14 semanas</option> <option value="2">2.- Ecografía 2° / 3° trimestre</option> <option value="0" selected>3.- Doppler + Eco. crecimiento</option> <option value="1">4.- Ecografía precoz de urgencia</option> <option value="3">5.- Ecografía Ginecológica</option> </select> </div><div class="col form-group mb-2"> <label for="interconsulta.respuesta.fecha"><strong class="text-white">Señalar fecha de examen</strong></label> <input type="date" class="form-control" id="interconsulta.respuesta.fecha"> </div><div class="col form-group mb-2"> <label><strong class="text-white">FUR Referida</strong></label> <input type="date" class="form-control" id="interconsulta.respuesta.fur.copia" disabled> </div><div class="col form-group" id="interconsulta.respuesta.edadgestacional"> <label for="interconsulta.respuesta.eg" class="text-white">Edad gestacional actual</label> <input type="hidden" class="form-control" id="interconsulta.fum.copia" value="solicitud_fum"> <input type="text" class="form-control" id="interconsulta.respuesta.eg" disabled=""> <input type="hidden" class="form-control" name="respuesta_eg"> </div></div>');
