$(document).ready(function(){
    ...
    $("#interconsulta\\.enviar").on("click", function(){
        ...
        if (nombre.length < 3 || rut.length < 4 || telefono.length < 6 || fecha.length < 4 || fum.length < 4 || diagnostico.length  < 3 || ciudad.length < 2 || lugar.length  < 3 || egestacional.length < 3){
            var mensaje = "";
            if (nombre.length < 3){
...
function construir(){
    ...
    $("#mensaje\\.resultado").parent().prepend('<div id="formulario.solicitud"> <div class="row"> <div class="col form-group"><label>Nombre del paciente</label><input type="text" class="form-control" id="interconsulta.nombre"> </div><div class="col form-group"><label>RUT del paciente</label><input type="text" class="form-control" id="interconsulta.rut"> </div><div class="col form-group"><label>Teléfono materno</label><input type="number" class="form-control" id="interconsulta.telefono"> </div></div><div class="row"> <div class="col-4 form-group"><label>FUM operacional</label><input type="date" class="form-control bg-secondary text-white" id="interconsulta.fum"> </div><div class="col form-group"><label>Fecha de solicitud del exámen</label><input type="date" class="form-control bg-secondary text-white" id="interconsulta.fecha"> </div><div class="col-4 form-group"><label>Edad Gestacional (Ege)</label><input type="text" class="form-control bg-secondary text-white" id="interconsulta.egestacional" disabled> </div></div><div class="row"> <div class="col-4 form-group"><label>Edad materna (años)</label><select class="form-control bg-secondary text-white" id="interconsulta.edad.materna"><option value="< 10">&lt; 10 años</option><option value="10">10 años</option><option value="11">11 años</option><option value="12">12 años</option><option value="13">13 años</option><option value="14">14 años</option><option value="15">15 años</option><option value="16">16 años</option><option value="17">17 años</option><option value="18">18 años</option><option value="19">19 años</option><option value="20">20 años</option><option value="21">21 años</option><option value="22">22 años</option><option value="23">23 años</option><option value="24">24 años</option><option value="25">25 años</option><option value="26">26 años</option><option value="27">27 años</option><option value="28">28 años</option><option value="29">29 años</option><option value="30">30 años</option><option value="31">31 años</option><option value="32">32 años</option><option value="33">33 años</option><option value="34">34 años</option><option value="35">35 años</option><option value="36">36 años</option><option value="37">37 años</option><option value="38">38 años</option><option value="39">39 años</option><option value="40">40 años</option><option value="41">41 años</option><option value="42">42 años</option><option value="43">43 años</option><option value="44">44 años</option><option value="45">45 años</option><option value="46">46 años</option><option value="47">47 años</option><option value="48">48 años</option><option value="49">49 años</option><option value="50">50 años</option><option value="> 10">&gt; 50 años</option></select></div><div class="col form-group"><label>Ciudad procedencia de la paciente</label><input type="text" class="form-control" id="interconsulta.ciudad"></div><div class="col form-group"><label>Lugar de control prenatal</label><input type="text" class="form-control" id="interconsulta.lugar"></div></div><div class="row"> <div class="col-4 form-group"><label>Diagnóstico de referencia a exámen ecográfico:</label></div><div class="col-8 form-group"><input type="text" class="form-control" id="interconsulta.diagnostico"> </div></div><div class="row"> <div class="col-4 py-4"> <button class="btn g-verde text-white" id="interconsulta.enviar">Enviar solicitud de exámen ecográfico a: </button> </div><div class="col form-group"> <label>Nombre</label> <input type="text" class="form-control" disabled id="interconsulta.texto.para.nombre"> </div><div class="col form-group"> <label>Email</label> <input type="text" class="form-control" disabled id="interconsulta.texto.para.email"> </div></div></div>');
    ...
    $("#interconsulta\\.texto\\.para\\.nombre").val($("#user_name").html());
    $("#interconsulta\\.texto\\.para\\.email").val($("#user_email").html());
}
