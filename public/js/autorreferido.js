        ...
        if (Object.keys(data).length > 0) {
            ...
            $('#tabla\\.resultado tr > td > button.examen').on("click", function(){
                ...
                $.get('dashboard/agendar/' + solicitud_id).done(function(data){
                    ...
                    $('#interconsulta\\.respuesta\\.crecimiento').data("em",data.solicitud_ematerna).data("pm",data.solicitud_media).data("imc",data.solicitud_imc).data("par", data.solicitud_paridad);
                });
