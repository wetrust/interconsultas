        ...
        if (Object.keys(data).length > 0) {
            ...
            $('#tabla\\.resultado tr > td > button.examen').on("click", function(){
                ...
                $.get('dashboard/agendar/' + solicitud_id).done(function(data){
                    ...
                    $('#interconsulta\\.respuesta\\.crecimiento').data("em",data.solicitud_ematerna).data("pm",data.solicitud_media).data("imc",data.solicitud_imc).data("par", data.solicitud_paridad).data("ant", data.solicitud_antecedentes);
                });
                $('#interconsulta\\.respuesta\\.crecimiento').on("change", function(){
                    if ($(this).val() == 4){
                        ...
                        $("input[name='respuesta_paridad']").val($('#interconsulta\\.respuesta\\.crecimiento').data("par"));
                        $("input[name='respuesta_antecedentes']").val($('#interconsulta\\.respuesta\\.crecimiento').data("ant"));
                    }
                    else if ($(this).val() == 3){
