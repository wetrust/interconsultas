    ...
    $.get('dashboard/process').done(function(data){
        ...
        if (Object.keys(data).length > 0) {
            ...
            $('#tabla\\.resultado tr > td > button.examen').on("click", function(){
                ...
                $("#ver\\.interconsulta\\.contenedor").append('<h5 class="my-3 text-center">Responder a esta solicitud de interconsulta</h5><div class="row"> <div class="col-3 form-group" id="jaja.papapa"> <label for="interconsulta.para">Fecha</label> <input type="text" disabled class="form-control" id="evaluacion_fecha"> </div><div class="col form-group"> <label for="interconsulta.comentario.respuesta">Comentario</label> <input disabled class="form-control" id="evaluacion_comentarios"/> </div></div><div class="row g-verde"> <div class="col form-group"> <label class="text-white">Nombre:</label> <input type="text" class="form-control" id="solicitud_nombreprofesional"> </div><div class="col form-group"> <label class="text-white">Email:</label> <input type="text" class="form-control" id="solicitud_email"> </div><div class="col form-group"> <button class="btn btn-link" id="solicitud.interconsulta.profesional.guardar">Guardar</button> </div></div>');
