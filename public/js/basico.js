...
function createCarcasaInterconsultaModal(id){
    ...
    div_id = uuidv4();
    btn_id = uuidv4();
    btn_modificar_id = uuidv4();

    var footerModal = '</div><div class="modal-footer"><button type="button" class="btn btn-primary" id="'+btn_modificar_id+'" data-id="'+id+'" data-modal="'+modal_id+'">Modificar solicitud</button><button type="button" class="btn btn-danger" id="'+btn_id+'" data-id="'+id+'" data-modal="'+modal_id+'">Eliminar solicitud</button><button type="button" class="btn btn-secondary" data-dismiss="modal">Volver</button></div></div></div></div>';
    ...
    $("#"+btn_modificar_id).on("click", function(){
        let solicitud_id =  $(this).data("id");
...
function createInterconsultaModal(id, contenedor){
    $.get('dashboard/agendar/' + id).done(function(data){
        $('#'+contenedor).empty().append('<input type="hidden" id="ax"><div class="col-4"> <label><small>Nombre del paciente:</small></label> <p id="bx"></p></div><div class="col-4"> <label><small>RUT del paciente:</small></label> <p id="cx"></p></div><div class="col-4"> <label><small>Teléfono materno:</small></label> <p id="dx"></p></div><div class="col-4 form-group"> <label><small>Ciudad de procedencia</small></label> <p id="ex"></p></div><div class="col-4 form-group"> <label><small>Lugar de control habitual</small></label> <p id="fx"></p></div><div class="col-4"> <label><small>Fecha solicitud del exámen:</small></label> <p id="gx"></p></div><div class="col-4"> <label><small>FUM operacional</small></label> <p id="hx"></p></div><div class="col-4"> <label><small>Edad Gestacional (Ege)</small></label> <p id="ix"></p></div><div class="col-4 form-group"> <label><small>Motivo de exámen</small></label> <p id="jx"></p></div><div class="col-6 form-group"> <label><small>Nombre del profesional referente:</small></label> <p id="llx"></p></div><div class="col-6 form-group"> <label><small>Email (de trabajo):</small></label> <p id="mx"></p></div><div class="col-6 form-group"> <label><small>Nombre del profesional contrarreferente:</small></label> <p id="kx"></p></div><div class="col-6 form-group"> <label><small>Email (de trabajo):</small></label> <p id="lx"></p></div>');
