...
function loadProfesionales(){
	$.get("api/profesionales").done(function(data){
		...
		$.each(data, function(element, value){
			let option = '<option value="'+value.user_email+'">'+user_name+'</option>';
