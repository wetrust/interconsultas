        ...
        $('#tabla\\.parto tr > td > button.ajuste').on("click", function(){
            ...
            $('#g3').click(function() {
                ...
                Highcharts.chart('graficoAjustado', {
                    title: {
                        text: 'Peso neonatal / Edad gestacional ajustada por variables para Curva Regional: Lagos y col. Rev. Chilena Obtet. Ginecol. 2009; 74(4). *',
                        style: {
                            "color": "#337ab7",
                            "fontSize": "12px"
                        }
