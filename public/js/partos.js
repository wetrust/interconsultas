    ...
    if (Object.keys(data).length > 0) {
        ...
        $('#tabla\\.parto tr > td > button.ajuste').on("click", function(){
            ...
            $('#g3').click(function() {
                ...
                $("#PesoEgeCAj").html("<strong>"+tres+"</strong>");
                ...
                $("#pesoCACondicion").html("<strong>"+condicion+"</strong>");
