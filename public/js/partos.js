    ...
    if (Object.keys(data).length > 0) {
        ...
        $('#tabla\\.parto tr > td > button.modificar').on("click", function(){
            ...
            $.get("dashboard/dataPartos/" + solicitud_id).done(function(data){
                ...
                $("#edad_materna").val(data.edad_materna);
            });
    ...
    if (Object.keys(data).length > 0) {
        ...
        $('#tabla\\.parto tr > td > button.ajuste').on("click", function(){
            ...
            $('#g3').click(function() {
                ...
                let pesoRnTemuco = RN.pesoTemuco();
                let pesoRnTemucoNegativo = (pesoRnTemuco < 0) ? true : false

                pesoRnTemuco = Math.abs(pesoRnTemuco);

                if (pesoRnTemuco < 10){
                    pesoRnTemuco = "0" + pesoRnTemuco;
                }

                if (pesoRnTemucoNegativo){
                    pesoRnTemuco = "-"+pesoRnTemuco;
                }

                $("#PesoEgeSAj").html(pesoRnTemuco);
