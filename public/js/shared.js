...
function segundoTrimestre(){
    ...
    $("select[name='respuesta_cisterna_m']").on("change", function(){
        if (this.value == "no procede" || this.value == "no evaluable"){
            document.getElementsByName("respuesta_sisterna_m_mm")[0].parentElement.classList.add("d-none");
        }else{
            document.getElementsByName("respuesta_sisterna_m_mm")[0].parentElement.classList.remove("d-none");
        }
    });
