<?php
    ...
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $html = '<table><tbody><tr><td></td><td style="background-color:#eceeef;">PFE (Hadlock) **:</td><td style="background-color:#eceeef;">'. $this->respuesta_pfe.' gr.</td><td style="background-color:#eceeef;">Percentil: '. $this->respuesta_pfe_pct.'</td></tr></tbody></table>';
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
