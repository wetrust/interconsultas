<?php
    ...
    $this->pdf->ImageSVG('@' . $this->grafico_dos, $x=100, $y=100, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=200, $y=0, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_dos, $x=200, $y=100, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
