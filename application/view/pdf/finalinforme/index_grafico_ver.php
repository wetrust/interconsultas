<?php
    ...
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=100, $y=20, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    ...
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=0, $y=80, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=100, $y=80, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
