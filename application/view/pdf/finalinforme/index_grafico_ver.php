<?php
    ...
    $this->pdf->ImageSVG('@' . $this->grafico_cinco, $x=10, $y=171, $w='', $h=90, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_seis, $x=105, $y=175, $w='', $h=90, $link='', $align='', $palign='', $border=0, $fitonpage=false);
