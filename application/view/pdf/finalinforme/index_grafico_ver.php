<?php
    ...
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=00, $y=000, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_dos, $x=50, $y=100, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_tres, $x=100, $y=00, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_cuatro, $x=100, $y=100, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_cinco, $x=200, $y=00, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
