<?php
    ...
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=105, $y=40, $w='', $h=90, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    ...
    $this->pdf->ImageSVG('@' . $this->grafico_cinco, $x=10, $y=173, $w='', $h=90, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_seis, $x=105, $y=173, $w='', $h=90, $link='', $align='', $palign='', $border=0, $fitonpage=false);
