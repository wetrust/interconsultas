<?php
    ...
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=2, $y=35, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=100, $y=35, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=2, $y=90, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=100, $y=90, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=2, $y=130, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
