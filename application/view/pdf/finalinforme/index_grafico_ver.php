<?php
    ...
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=10, $y=160, $w='', $h=90, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_uno, $x=100, $y=160, $w='', $h=90, $link='', $align='', $palign='', $border=0, $fitonpage=false);
