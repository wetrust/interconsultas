<?php
    ...
    $html = '<h5 style="color:#0275d8;"><em>Datos de referencia para evaluación ecográfica.</em></h5>';
    ...
    $html = '<h5 style="color:#0275d8;"><em>Resumen examen ecográfico y flujometría Doppler materno / fetal.</em></h5>';
    $this->pdf->writeHTMLCell('', '', '10', '', $html, 0, 1, 0, true, 'L', true);
    $this->pdf->Ln(2);
