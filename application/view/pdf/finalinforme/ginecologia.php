<?php
    ...
    $html = '<h2 style="border-bottom:4px double #000;text-align: center;"><strong>RESUMEN PROTOCOLO DE REFERENCIA Y CONTRARREFERENCIA PARA ECOGRAFÍA GINECOLÓGICA</strong></h2>';
    $this->pdf->writeHTMLCell('', '', '10', '', $html, 0, 1, 0, true, 'C', true);
    $this->pdf->Ln(2);
    $html = '<h2 style="border-bottom:1px double #000;text-align: left;">A- Formulario referencia para evaluación ecográfica ginecológica</h2>';
    ...
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(2);
    $html = '<table><tbody><tr><td><strong>Endometrio</strong>: '. $this->respuesta_endometrio.'</td></tr></tbody></table>';
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(2);
    $html = '<table><tbody><tr><td><strong>Anexo Izquierdo</strong>: '. $this->respuesta_anexo_izquierdo_ginecologica.'</td></tr></tbody></table>';
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(2);
    $html = '<table><tbody><tr><td><strong>Anexo Derecho</strong>: '. $this->respuesta_anexo_derecho_ginecologica.'</td></tr></tbody></table>';
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(2);
    $html = '<table><tbody><tr><td><strong>Ovario Izquierdo</strong>: '. $this->respuesta_ovario_izquierdo.'</td></tr></tbody></table>';
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(2);
    $html = '<table><tbody><tr><td><strong>Ovario Derecho</strong>: '. $this->respuesta_ovario_derecho.'</td></tr></tbody></table>';
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(2);
    $html = '<table><tbody><tr><td><strong>Douglas</strong>: '. $this->respuesta_douglas_ginecologica.'</td></tr></tbody></table>';
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(2);
