<?php
    ...
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, 'J', true);
    $this->pdf->Ln(4);
    $html = '<table><tbody><tr><td style="background-color:#f7fafb;"><strong>Útero:</strong></td><td style="background-color:#f7fafb;width:450px;">'. $this->respuesta_utero_ginecologica.'</td></tr></tbody></table>';
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(1);
    ...
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(4);
    $html = '<table><tbody><tr><td style="background-color:#f7fafb;"><strong>Anexo Izquierdo:</strong></td><td style="background-color:#f7fafb;width:450px;">'. $this->respuesta_anexo_izquierdo_ginecologica.'</td></tr></tbody></table>';
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(1);
    $html = '<table><tbody><tr><td><strong>Ovario Izquierdo:</strong></td><td style="width:450px">'. $this->respuesta_ovario_izquierdo.'</td></tr></tbody></table>';
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(4);
    $html = '<table><tbody><tr><td style="background-color:#f7fafb;"><strong>Anexo Derecho:</strong></td><td style="background-color:#f7fafb;width:450px;">'. $this->respuesta_anexo_derecho_ginecologica.'</td></tr></tbody></table>';
    $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, '', true);
    $this->pdf->Ln(1);
