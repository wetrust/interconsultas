<?php
    ...
    if ($this->respuesta_saco_eg && $this->respuesta_lcn == ""){
        $_html .= "<br>- Calculo inicial de edad gestacional según promedio de saco: ". $this->respuesta_saco_eg ." semanas<br>- Agendar próxima ecografía para determinar edad gestacional por LCN<br>";
    }
