<?php
    ...
    $_html = "Calculo inicial de edad según saco gestacional: ". $this->respuesta_saco_eg ." semanas<br>Agendar próximo control para determinar edad gestacional por LCN<br>" . $_html;
