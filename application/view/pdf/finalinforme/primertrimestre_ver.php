<?php
    ...
    if (Session::get("user_account_type") == 4) {
        $html = '<table><tbody><tr><td colspan="2">Nombre del paciente</td><td>: '.htmlentities($this->solicitud->solicitud_nombre).'</td><td></td></tr></tbody></table>';
        $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, 'J', true);
        $this->pdf->Ln(1);
        $html = '<table><tbody><tr><td colspan="2">Edad</td><td>: '.htmlentities($this->solicitud->solicitud_ematerna).' años</td><td></td></tr></tbody></table>';
        $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, 'J', true);
        $this->pdf->Ln(1);
        $html = '<table><tbody><tr><td colspan="2">RUT (DNI)</td><td>: '.htmlentities($this->solicitud->solicitud_rut).'</td><td></td></tr></tbody></table>';
        $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, 'J', true);
        $this->pdf->Ln(1);
        $html = '<table><tbody><tr><td colspan="2">Fecha solicitud de la ecografía</td><td>: '.$solicitud_fecha.'</td><td></td></tr></tbody></table>';
        $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, 'J', true);
        $this->pdf->Ln(1);
        $html = '<table><tbody><tr><td colspan="2">FUR referida o corregida</td><td>: '.$solicitud_fum.'</td><td></td></tr></tbody></table>';
        $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, 'J', true);
        $this->pdf->Ln(1);
        $html = '<table><tbody><tr><td colspan="2">Edad gestacional</td><td>: '.htmlentities($this->solicitud->solicitud_egestacional).'</td><td></td></tr></tbody></table>';
        $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, 'J', true);
        $this->pdf->Ln(1);
        $html = '<table><tbody><tr><td colspan="2">Motivo de exámen</td><td>: '.htmlentities($this->solicitud->solicitud_diagnostico).'</td><td></td></tr></tbody></table>';
        $this->pdf->writeHTMLCell('', '', '', '', $html, 0, 1, 0, true, 'J', true);
        $this->pdf->Ln(4);
    }
    else{
