<?php
    ...
    if ($this->respuesta_saco_eg && $this->respuesta_lcn == ""){
        $_html .= "<br>- <strong>Calculo inicial</strong> de edad gestacional según promedio de saco: ". $this->respuesta_saco_eg ." semanas<br>- Se sugiere agendar nuevo exámen para determinación de edad gestacional por largo embrionario<br>";
    }
