<?php
    ...
    $this->pdf->ImageSVG('@' . $this->grafico_tres, $x=10, $y=120, $w='', $h=90, $link='', $align='', $palign='', $border=0, $fitonpage=false);
    $this->pdf->ImageSVG('@' . $this->grafico_cuatro, $x=105, $y=120, $w='', $h=90, $link='', $align='', $palign='', $border=0, $fitonpage=false);
