<?php
    ...
    $html = '<h4 style="border-bottom:1px solid #000;text-align: center;">PROTOCOLO REFERENCIA-CONTRARREFERENCIA PARA EVALUACIÓN ULTRASONOGRÁFICA DEL CRECIMIENTO</h4>';
