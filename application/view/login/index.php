    ...
    <div class="row">
        ...
        <div class="col-8 mt-2">
            <div class="mx-3 px-5">
                ...
                <br>Si es de su interés usar este servicio es necesario contratar un servidor cloud con proveedores como "Google Cloud Computing" o "Amazon AWZ".
                <br>Para mayor información, favor contactarse con nosotros al email examenecografico@gmail.com
                <br>Si ud. desea probar la plataforma de interconsultas, puede usar el usuario invitado (Usuario: prueba@prueba.cl; Contraseña: 123abc). Pruebe el sistema solicitando una interconsulta para el médico referente (prueba@prueba.cl) en <strong>crecimientofetal.cl</strong> y observe como llega esta solicitud en este panel de administración</h6>
            </div>
        </div>
    </div>
</div>
