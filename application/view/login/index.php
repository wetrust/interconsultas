    ...
    <div class="row">
        ...
        <div class="col-8 mt-2">
            ...
            <ul>
                ...
                <li class="text-justify text-primary">Si desea probar la plataforma de interconsultas, puede usar el usuario invitado ( Usuario: prueba@prueba.cl; Contraseña: 123abc ).</li>
