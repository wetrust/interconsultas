        ...
        <div class="tab-pane fade show active" id="interconsulta" role="tabpanel" aria-labelledby="interconsulta-tab">
            ...
            <div class="card my-2 shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="row"><div class="col-3 form-group mb-0 pb-3"> <label>Filtrar por fecha agendada</label> <input type="date" id="fecha.espera" class="form-control"> </div><div class="col-2">
                            <label>Filtro</label>
                            <div class="btn-group" role="group">
