...
class ApiModel
{
    ...
    public static function getPartos($token, $parto_id){
        ...
        if ($query->rowCount() == 1){
            ...
            $response = new stdClass(); $response->return = false; return $response;
        }
    }
    ...
    public static function updatePartos($token, $parto_id, $peso, $talla, $imc, $estado_nutricional, $etnia, $paridad, $lugar, $pesofetal, $tallafetal, $craneofetal, $apgar_uno, $apgar_cinco, $sexo, $meconio, $ipn, $peso_eg, $peso_eg_estado, $ipn_eg, $ipn_eg_estado, $comentarios, $rnsintomatico, $rn, $factores, $edad_materna, $pesoegcorregido, $pesoegcorregidoestado)
    {
        ...
        if ($query->rowCount() == 1){
            return PartosModel::updatePartos($parto_id, $peso, $talla, $imc, $estado_nutricional, $etnia, $paridad, $lugar, $pesofetal, $tallafetal, $craneofetal, $apgar_uno, $apgar_cinco, $sexo, $meconio, $ipn, $peso_eg, $peso_eg_estado, $ipn_eg, $ipn_eg_estado, $comentarios, $rnsintomatico, $rn, $factores, $edad_materna, $pesoegcorregido, $pesoegcorregidoestado);
        }else{
            $response = new stdClass();
            $response->return = false;
            return $response;
