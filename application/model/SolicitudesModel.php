...
class SolicitudesModel
{
    ...
    public static function createSolicitud($solicitud_nombre_referente, $solicitud_profesionalemail,$solicitud_nombre,$solicitud_apellido,$solicitud_rut,$solicitud_fecha,$solicitud_diagnostico,$solicitud_lugar,$solicitud_ciudad,$solicitud_profesional,$solicitud_nombreprofesional,$solicitud_email,$solicitud_fum,$solicitud_respuesta,$solicitud_egestacional,$telefono, $sistolica, $diastolica, $media, $talla, $peso, $imc, $antecedentes, $edadMaterna, $paridad){
        ...
        $sql = "INSERT INTO solicitudes (solicitud_nombre_referente, solicitud_profesionalemail,solicitud_nombre,solicitud_apellido,solicitud_rut,solicitud_fecha,solicitud_diagnostico,solicitud_lugar,solicitud_ciudad,solicitud_profesional,solicitud_nombreprofesional,solicitud_email,solicitud_fum,solicitud_respuesta,solicitud_egestacional,solicitud_telefono,solicitud_sistolica,solicitud_diastolica,solicitud_media,solicitud_talla,solicitud_peso,solicitud_imc,solicitud_antecedentes,solicitud_ematerna,solicitud_paridad) VALUES (:solicitud_nombre_referente, :solicitud_profesionalemail,:solicitud_nombre,:solicitud_apellido,:solicitud_rut,:solicitud_fecha,:solicitud_diagnostico,:solicitud_lugar,:solicitud_ciudad,:solicitud_profesional,:solicitud_nombreprofesional,:solicitud_email,:solicitud_fum,:solicitud_respuesta,:solicitud_egestacional, :solicitud_telefono, :solicitud_sistolica, :solicitud_diastolica, :solicitud_media, :solicitud_talla, :solicitud_peso, :solicitud_imc, :solicitud_antecedentes, :solicitud_ematerna, :solicitud_paridad)";
        $query = $database->prepare($sql);
