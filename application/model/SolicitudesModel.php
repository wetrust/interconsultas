...
class SolicitudesModel
{
    ...
    public static function createSolicitud($solicitud_nombre_referente, $solicitud_profesionalemail,$solicitud_nombre,$solicitud_rut,$solicitud_fecha,$solicitud_diagnostico,$solicitud_lugar,$solicitud_ciudad,$solicitud_profesional,$solicitud_nombreprofesional,$solicitud_email,$solicitud_fum,$solicitud_respuesta,$solicitud_egestacional,$telefono, $sistolica, $diastolica, $media, $talla, $peso, $imc, $antecedentes){
        ...
        $sql = "INSERT INTO solicitudes (solicitud_nombre_referente, solicitud_profesionalemail,solicitud_nombre,solicitud_rut,solicitud_fecha,solicitud_diagnostico,solicitud_lugar,solicitud_ciudad,solicitud_profesional,solicitud_nombreprofesional,solicitud_email,solicitud_fum,solicitud_respuesta,solicitud_egestacional,solicitud_telefono,solicitud_sistolica,solicitud_diastolica,solicitud_media,solicitud_talla,solicitud_peso,solicitud_imc,solicitud_antecedentes) VALUES (:solicitud_nombre_referente, :solicitud_profesionalemail,:solicitud_nombre,:solicitud_rut,:solicitud_fecha,:solicitud_diagnostico,:solicitud_lugar,:solicitud_ciudad,:solicitud_profesional,:solicitud_nombreprofesional,:solicitud_email,:solicitud_fum,:solicitud_respuesta,:solicitud_egestacional, :solicitud_telefono, :solicitud_sistolica, :solicitud_diastolica, :solicitud_media, :solicitud_talla, :solicitud_peso, :solicitud_imc, :solicitud_antecedentes)";
        $query = $database->prepare($sql);
        $query->execute(array(':solicitud_nombre_referente' => $solicitud_nombre_referente, ':solicitud_profesionalemail' => $solicitud_profesionalemail,':solicitud_nombre' => $solicitud_nombre,':solicitud_rut' => $solicitud_rut,':solicitud_fecha' => $solicitud_fecha,':solicitud_diagnostico' => $solicitud_diagnostico,':solicitud_lugar' => $solicitud_lugar,':solicitud_ciudad' => $solicitud_ciudad,':solicitud_profesional' => $solicitud_profesional,':solicitud_nombreprofesional' => $solicitud_nombreprofesional,':solicitud_email' => $solicitud_email,':solicitud_fum' => $solicitud_fum,':solicitud_respuesta' => $solicitud_respuesta,':solicitud_egestacional' => $solicitud_egestacional, ':solicitud_telefono' => $telefono, ':solicitud_sistolica' => $sistolica, ':solicitud_diastolica' => $diastolica, ':solicitud_media' => $media, ':solicitud_talla' => $talla, ':solicitud_peso' => $peso, ':solicitud_imc' => $imc, ':solicitud_antecedentes' => $antecedentes));
