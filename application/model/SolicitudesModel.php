...
class SolicitudesModel
{
    ...
    public static function createSolicitud($solicitud_nombre_referente, $solicitud_profesionalemail,$solicitud_nombre,$solicitud_rut,$solicitud_fecha,$solicitud_eg,$solicitud_alteraciones,$solicitud_diagnostico,$solicitud_lugar,$solicitud_ciudad,$solicitud_profesional,$solicitud_nombreprofesional,$solicitud_email,$solicitud_fum,$solicitud_respuesta,$solicitud_egestacional,$telefono)
    {
        ...
        $sql = "INSERT INTO solicitudes (solicitud_nombre_referente, solicitud_profesionalemail,solicitud_nombre,solicitud_rut,solicitud_fecha,solicitud_eg,solicitud_alteraciones,solicitud_diagnostico,solicitud_lugar,solicitud_ciudad,solicitud_profesional,solicitud_nombreprofesional,solicitud_email,solicitud_fum,solicitud_respuesta,solicitud_egestacional,solicitud_telefono) VALUES (:solicitud_nombre_referente, :solicitud_profesionalemail,:solicitud_nombre,:solicitud_rut,:solicitud_fecha,:solicitud_eg,:solicitud_alteraciones,:solicitud_diagnostico,:solicitud_lugar,:solicitud_ciudad,:solicitud_profesional,:solicitud_nombreprofesional,:solicitud_email,:solicitud_fum,:solicitud_respuesta,:solicitud_egestacional, :solicitud_telefono)";
        $query = $database->prepare($sql);
        $query->execute(array(':solicitud_nombre_referente' => $solicitud_nombre_referente, ':solicitud_profesionalemail' => $solicitud_profesionalemail,':solicitud_nombre' => $solicitud_nombre,':solicitud_rut' => $solicitud_rut,':solicitud_fecha' => $solicitud_fecha,':solicitud_eg' => $solicitud_eg,':solicitud_alteraciones' => $solicitud_alteraciones,':solicitud_diagnostico' => $solicitud_diagnostico,':solicitud_lugar' => $solicitud_lugar,':solicitud_ciudad' => $solicitud_ciudad,':solicitud_profesional' => $solicitud_profesional,':solicitud_nombreprofesional' => $solicitud_nombreprofesional,':solicitud_email' => $solicitud_email,':solicitud_fum' => $solicitud_fum,':solicitud_respuesta' => $solicitud_respuesta,':solicitud_egestacional' => $solicitud_egestacional, ':solicitud_telefono' => $telefono));
