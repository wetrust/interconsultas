...
class RespuestaModel
{
    ...
    public static function createRespuesta($solicitud_id, $fecha, $eg, $pfe, $pfe_percentil, $liquido, $presentacion, $dorso, $uterinas, $uterinas_percentil, $umbilical, $umbilical_percentil, $cm, $cm_percentil, $cmau, $cmau_percentil, $hipotesis, $comentariosexamen, $ecografista, $doppler, $anatomia_fetal, $tipo, $utero_primertrimestre, $saco_gestacional, $embrion, $lcn, $anexo_izquierdo_primertrimestre, $anexo_derecho_primertrimestre, $douglas_primertrimestre, $lcn_eg, $placenta,$placenta_insercion, $liquido_amniotico, $dbp, $cc, $ca, $lf, $pfe_segundo, $ccca, $presentacion_segundo, $dorso_segundo, $anatomia_segundo, $pfe_pct_segundo, $ccca_pct, $hipotesis_segundo, $utero_ginecologica, $endometrio, $anexo_izquierdo_ginecologica, $anexo_derecho_ginecologica, $ovario_izquierdo, $ovario_derecho, $douglas_ginecologica, $crecimiento_ccca, $doppler_fetal)
    {
        if (!$solicitud_id) {
