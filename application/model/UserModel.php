...
class UserModel
{
    ...
    public static function getPublicProfilesOfAllUsers()
    {
        ...
        $sql = "SELECT user_id, user_name, user_email, user_account_type, user_almacenamiento, user_active, user_has_avatar, user_deleted FROM users";
        ...
        foreach ($query->fetchAll() as $user) {
            ...
            $all_users_profiles[$user->user_id]->user_almacenamiento = $user->user_almacenamiento;
    ...
    public static function getPublicProfileOfUser($user_id)
    {
        ...
        $sql = "SELECT user_id, user_name, user_email, user_almacenamiento, user_active, user_has_avatar, user_deleted, user_profesion
